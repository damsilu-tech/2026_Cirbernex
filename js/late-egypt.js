...
/* ------ Script switcher: Hieroglyphs / Hieratic / Demotic ------ */
const scriptTabs = document.querySelectorAll('.lp-script-tab');
const scriptPanels = document.querySelectorAll('.lp-script-panel');
...
scriptTabs.forEach(tab => {
  tab.addEventListener('click', () => {
    ...
    scriptPanels.forEach(panel => {
      panel.classList.toggle('active', panel.getAttribute('data-script-panel') === target);
    });
  });
});