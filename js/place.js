...
// ---- Deep link support (place.html?id=... used from older links) ----
const pageParams = new URLSearchParams(window.location.search);
const requestedPlace = pageParams.get('id');
if (requestedPlace) {
...
if (browseSearch) browseSearch.addEventListener('input', applyFilters);
if (periodFilter) periodFilter.addEventListener('change', applyFilters);

// ---- Init ----
if (browseGrid && browseEmpty) {
